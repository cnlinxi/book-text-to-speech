...
GriffinLim将幅度谱恢复为原始波形，但是相比原始波形，幅度谱缺失了原始相位谱信息。音频一般采用的是短视傅里叶变化，也就是将音频分割成帧(每帧0.25ms-0.35ms)，再进行傅里叶变化，帧与帧之间是有重叠的(可百度了解stft)。

griffin lim算法是利用两帧之间的重叠部分重构信号，而且中间用了hanning窗等，所以如果要griffin lim算法还原的信号质量较好，尽量保证两帧之间重叠越多越好（一般帧移为每一帧长的25\%左右，也就是75\%的重叠为宜）。
...
https://zhuanlan.zhihu.com/p/424846347
https://zhuanlan.zhihu.com/p/25002923
https://zhuanlan.zhihu.com/p/102539783
https://zhuanlan.zhihu.com/p/32321773
https://zhuanlan.zhihu.com/p/66809424
